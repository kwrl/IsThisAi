...
public class SigmoidNeuronShould
{
    ...
    public void ProduceAnOutput__When__Activated(double[] weights, double bias, double[] inputs, double expectedOutput)
    {
        ...
        neuron.Input = inputs;
        neuron.Output.ShouldBe(0.0);
        neuron.Activate();
        neuron.Output.ShouldBe(expectedOutput, tolerance: 0.0001);
    }
}
